...
public ResponseEntity<StudentDTO> getById(@PathVariable Long id) {
    ...
    @GetMapping("/gr/{gr}")
public ResponseEntity<StudentDTO> getByGr(@PathVariable String gr) {
    return ResponseEntity.ok(
        studentMapper.toDto(studentService.getByGrNumber(gr))
    );
}
...
public ResponseEntity<List<StudentDTO>> getAdmissionReport(
